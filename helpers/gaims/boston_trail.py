...
last_names = [
    ...
    "Moore", "Martin", "Jackson", "Thompson", "White", "Brown"
]
...
class BostonTrail(BaseGaim):
    def __init__(self, txo, txi):
        ...
        self.gaim_commands["travel"] = {
            "name": "travel",
            "usage": '"travel [DISTANCE]"',
            "call_func": self.travel_farther,
            "lite_desc": "Travel farther, possibly encounter an event.",
            "full_desc": ["Travel farther, possibly encounter an event."],
            "possible_args": {
                "[DISTANCE]": {
                    '0': "Wouldn't make too much sense to travel 0 miles.",
                    '15': 'A sensible amount to travel by foot in a day.',
                    '420': "Good friggin' luck."
                }
            },
            "args_desc": {'[DISTANCE]': 'How many miles to travel.'},
            "examples": ["travel 42", "travel 67", "travel 420", "travel 6900"],
            "group_tag": "BTRL",
            "font_color": t.rgb_to_hex(t.CONTINENTAL_BLUE),
            "back_color": t.rgb_to_hex(t.BLACK)}
        self.gaim_commands["hunt"] = {
            "name": "hunt",
            "usage": '"hunt [ANIMAL]"',
            "call_func": self.animal_hunt,
            "lite_desc": "Hunt animals, possibly encounter an event.",
            "full_desc": ["Hunt animals, possibly encounter an event."],
            "possible_args": {
                "[ANIMAL]":{
                    "deer": "Deers are easier to spot, harder too kill.",
                    "rabbit": "Rabbits are harder to spot, easier to kill.",
                    "grizzly": "Grizzly bears are easier to spot, easier to kill."
                }
            },
            "args_desc": {'[ANIMAL]': 'Animal for hunting.'},
            "examples": ["hunt grizzly", "hunt rabbit", "hunt deer"],
            "group_tag": "BTRL",
            "font_color": t.rgb_to_hex(t.CONTINENTAL_BLUE),
            "back_color": t.rgb_to_hex(t.BLACK)}
        self.gaim_commands["gather"] = {
            "name": "gather",
            "usage": "gather [ITEM_TYPE]",
            "call_func": self.gather_stuff,
            "lite_desc": "Gather things, possibly encounter an event.",
            "full_desc": ["Gather things, possibly encounter an event."],
            "possible_args": {'[ITEM_TYPE]': ['water', 'berries', 'herbs']},
            "args_desc": {
                '[ITEM_TYPE]': {
                    'water': "Fill up any and all containers meant for water.",
                    'berries': "Fill all berry baskets with berries.",
                    'herbs': 'Fill all herb sachets with medicinal and edible herbs.'
                }
            },
            "examples": ['gather water', 'gather herbs', 'gather berries'],
            "group_tag": "BTRL",
            "font_color": t.rgb_to_hex(t.CONTINENTAL_BLUE),
            "back_color": t.rgb_to_hex(t.BLACK)}
        self.gaim_commands["rest"] = {
            "name": "rest",
            "usage": "rest [TIME]",
            "call_func": self.party_rest,
            "lite_desc": "Allow the party to rest/eat.",
            "full_desc": ["Allow the party to rest/eat."],
            "possible_args": {'[TIME]': 'Length of time to rest.'},
            "args_desc": {
                '[TIME]': {
                    '0': "Wouldn't make too much sense to rest 0 hours.",
                    '15': 'A sensible amount to travel by foot in a day.',
                    '420': "Good friggin' luck."
                }},
            "examples": [],
