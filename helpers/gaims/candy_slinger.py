...
class CandySlingerRunner(BaseGaim):
    def __init__(self, txo, txi):
        ...
        self.gaim_commands["move"] = {
            "name": "move",
            "usage": "move [LOCATION]",
            "call_func": self.move_location,
            "lite_desc": "Move to a new location in the city.",
            "full_desc": ["Move to a new location in the city."],
            "possible_args": {'[LOCATION]': 'Destination to move to.'},
            "args_desc": {
                "[LOCATION]": "New location to move to."
            },
            "examples": ["move park", "move library", "move theater"],
            "group_tag": "CNDY",
            "font_color": t.rgb_to_hex(t.LIGHT_SEA_GREEN),
            "back_color": t.rgb_to_hex(t.BLACK)}
        self.gaim_commands["buy"] = {
            "name": "buy",
            "usage": "buy [AMOUNT] [CANDY]",
            "call_func": self.buy_candy,
            "lite_desc": "Buy some candy from your location.",
            "full_desc": ["Buy some candy from your location."],
            "possible_args": {
                'amount': 'Amount of candy to buy.',
             'candy': 'Candy name to buy.'},
            "args_desc": {},
            "examples": [],
            "group_tag": "CNDY",
            "font_color": t.rgb_to_hex(t.LIGHT_SEA_GREEN),
            "back_color": t.rgb_to_hex(t.BLACK)}
        self.gaim_commands["sell"] = {
            "name": "sell",
            "usage": "'sell [AMOUNT] [CANDY]'",
            "call_func": self.sell_candy,
            "lite_desc": "Sell some candy where you are.",
            "full_desc": ["Sell some candy where you are."],
            "possible_args": {
                '[AMOUNT]': 'Amount of candy to sell.',
                '[CANDY]': 'Candy name to sell.'
            },
            "args_desc": {
                '[AMOUNT]': 'Amount of candy to sell.',
                '[CANDY]': 'Name of candy to sell.'
            },
            "examples": ['sell 12 skittle', 'sell 7 dumdum', 'sell 13 gumdrops'],
            "group_tag": "CNDY",
            "font_color": t.rgb_to_hex(t.LIGHT_SEA_GREEN),
            "back_color": t.rgb_to_hex(t.BLACK)}
