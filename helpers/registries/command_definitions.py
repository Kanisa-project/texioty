...
PIJUN_COMMANDS: Dict[str, Dict[str, Any]] = {
    ...
    'deliver': {
        ...
        'call_func': None,
        'lite_desc': 'Delivers a game to a host.',
        'full_desc': ['Delivers a game to a host.'],
        'possible_args': {},
...
DOVECOT_COMMANDS= {
    'host': {
        'name': 'host',
        'usage': '"host [dovecot_num] (game_engine)"',
        'call_func': None,
        'lite_desc': 'Host a game.',
        'full_desc': ['Host a game.'],
        'possible_args': {},
        'args_desc': {'[dovecot_num]': ['The dovecot number to host 0-255.', int],
                      '(game_engine)': ['The game engine to use.', str]},
        'examples': ['host 124', 'host 124 slinger'],
        'group_tag': 'DOVE',
        'font_color': u.rgb_to_hex(t.PIGEON_GREY),
        'back_color': u.rgb_to_hex(t.BLACK)
    },
